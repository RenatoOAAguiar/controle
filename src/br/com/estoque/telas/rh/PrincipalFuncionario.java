...
public class PrincipalFuncionario extends JFrame {
	...
	protected void preencheTable(){
		...
		try{
			...
			modelo.addRow(new String[]{listaFuncionario.get(i).getNome(),masc.mascaraCPF(listaFuncionario.get(i).getCpf()),
					listaFuncionario.get(i).getDataNasc().toLocaleString().split(" ")[0],listaFuncionario.get(i).getCargo().getNome()});
			}
